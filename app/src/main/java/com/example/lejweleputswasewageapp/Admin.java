...
public class Admin extends AppCompatActivity {
    ...
    Button btnSendNotification,btnUpdateProgress,btnViewLocations,btnCheckComplaints;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnViewLocations.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(Admin.this,ViewLocations.class));
            }
        });
        ...
        btnSendNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Admin.this,AdminNotifications.class));
